...
function App() {
    ...
    return ( <Router >
        ...
        <div className = "logo" > Communication Tracker </div> <ul className = "nav-links" >
        <li >
        <NavLink to = "/"
        className = {
            ({
        ...
        Calendar </NavLink> </li> <li>
        <NavLink to = "/notification"
        className = "overdue-notification" >
        <Bell size = {
            24
        }/> {
