...
import "../css/routes/userDashboard.css";
        ...
        <div className="user-dashboard">
            ...
            <section className="companies-grid">
                {state.companies.map((company) => {
                    ...
                    const nextScheduledCommunication = getNextScheduledCommunication(company.id);

                    return (
                        <div key={company.id} className={`company-row ${getCompanyStatus(company)}`}>
                            <input
                                type="checkbox"
                            ...
                            <div className="last-communications">
                                ...
                                {lastFiveCommunications.map((comm) => (
                                    ...
                                    >
                                        ...
                                        {selectedCommunication === comm && renderCommunicationTooltip(comm)}
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="next-communication">
                                ...
                                {nextScheduledCommunication ? (
                                    <div>
                                        {nextScheduledCommunication.type} - {formatDate(nextScheduledCommunication.date)}
                                    </div>
                                ) : (
